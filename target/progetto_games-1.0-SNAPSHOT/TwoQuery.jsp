...
<div class="main">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Search Game filtered by Genre</h6>
        </div>
        <div class="card-body">
            <form id="searchQueryUno" action="ServletQuerys" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="Genre" class="form-control" required name="Genre" placeholder="Insert Genre">
                        <input type="hidden" name="query" value="two">
                    </div>
                </div>
    ...
    <% 	if(request.getAttribute("result2")!=null){
        ArrayList<Game> result = (ArrayList<Game>) request.getAttribute("result2");
