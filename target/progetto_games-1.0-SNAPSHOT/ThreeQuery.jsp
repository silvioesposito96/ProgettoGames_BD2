...
<div class="main">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Search Game by Name</h6>
        </div>
        <div class="card-body">
            <form id="searchQueryUno" action="ServletQuerys" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="Name" class="form-control" required name="Name" placeholder="Insert Name">
