...
<div class="main">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Search Game filtered by Platform</h6>
        </div>
        <div class="card-body">
            <form id="searchQueryUno" action="ServletQuerys" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label class="text-black">Platform</label>
                        <input type="text" name="Platform" class="form-control" required name="Platform" placeholder="Insert Platform">
                        <input type="hidden" name="query" value="one">
                    </div>
                </div>
